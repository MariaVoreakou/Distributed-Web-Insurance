            ...
            <div>
                ...
                <div class="outer-content">
                        ...
                        <div class="inner-content">
                            <p class="p-style-form-title" style="margin-top:100px;">Η αίτηση καταχωρήθηκε επιτυχώς</p>
                            <p class="p-style-form-title" style="margin-top:50px;">Μετάβαση στο αρχικό <a href="index.jsp">μενού</a></p>
                        </div>
                    </div>
                </div>   
