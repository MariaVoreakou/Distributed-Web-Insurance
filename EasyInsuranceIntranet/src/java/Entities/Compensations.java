...
@NamedQueries({
    ...
    @NamedQuery(name = "Compensations.administrator", query = "SELECT c FROM Compensations c WHERE c.compCost >= 2000 "),
    @NamedQuery(name = "Compensations.managers", query = "SELECT c FROM Compensations c WHERE c.compCost > 300 "),
    @NamedQuery(name = "Compensations.sales", query = "SELECT c FROM Compensations c WHERE c.compCost <=300 "),
    @NamedQuery(name = "Compensations.pending", query = "SELECT c FROM Compensations c WHERE c.approvalType.apprID = 1 "),
