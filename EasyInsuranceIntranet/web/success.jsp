    ...
    <body>
        ...
        <div class="grey-background">
            ...
            <div class="form-customer">
                <div class="div-inner">
                    <p class="p-style-form-title" style="margin-top:150px;">Η αίτηση καταχωρήθηκε επιτυχώς</p>
                    <p class="p-style-form-title" style="margin-top:50px;">Μετάβαση στο αρχικό <a href="menu.jsp">μενού</a></p>
                </div>
            </div>
